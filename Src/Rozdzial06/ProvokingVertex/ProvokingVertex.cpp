...
void KeyPressFunc(unsigned char key, int x, int y)
	...
	if(key == 32)
		...
		if(nToggle %2 == 0) {
			...
			glutSetWindowTitle("Prowokowanie wierzcho³ków - ostatni wierzcho³ek - naciœnij spacjê");
			}
		else {
			glProvokingVertex(GL_FIRST_VERTEX_CONVENTION);
			glutSetWindowTitle("Prowokowanie wierzcho³ków - pierwszy wierzcho³ek - naciœnij spacjê");
			}
...
int main(int argc, char* argv[])
	...
	glutCreateWindow("Prowokowanie wierzcho³ków - pierwszy wierzcho³ek - naciœnij spacjê");
